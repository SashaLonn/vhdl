...
vcom -93 -work work {C:/vhdl_git/examensarbete/status_display_system.vhd}
vcom -93 -work work {C:/vhdl_git/examensarbete/ssi_pkg.vhd}
vcom -93 -work work {C:/vhdl_git/examensarbete/sju_seg_display.vhd}
vcom -93 -work work {C:/vhdl_git/examensarbete/ssi_slave.vhd}
vcom -93 -work work {C:/vhdl_git/examensarbete/ssi_master.vhd}
vcom -93 -work work {C:/vhdl_git/examensarbete/ssi_top.vhd}

vcom -93 -work work {C:/vhdl_git/examensarbete/simulation/modelsim/ssi_top.vht}

vsim -t 1ps -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L fiftyfivenm -L rtl_work -L work -voptargs="+acc"  ssi_top_vhd_tst
