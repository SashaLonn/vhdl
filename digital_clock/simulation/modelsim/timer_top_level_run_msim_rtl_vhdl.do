...
vcom -93 -work work {C:/vhdl_git/digital_clock/SJU_SEG_DISPLAYER.vhd}
vcom -93 -work work {C:/vhdl_git/digital_clock/status_display_system.vhd}
vcom -93 -work work {C:/vhdl_git/digital_clock/clock_divider.vhd}
vcom -93 -work work {C:/vhdl_git/digital_clock/timer_top_level.vhd}
vcom -93 -work work {C:/vhdl_git/digital_clock/timer_counter.vhd}
vcom -93 -work work {C:/vhdl_git/digital_clock/bcd_splitter.vhd}

vcom -93 -work work {C:/vhdl_git/digital_clock/simulation/modelsim/timer_top_level.vht}

vsim -t 1ps -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L fiftyfivenm -L rtl_work -L work -voptargs="+acc"  timer_top_level_vhd_tst
